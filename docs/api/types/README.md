...
CommandContext provides unified access to all SDK utilities This interface will be passed to all commands, giving them access to: - Core utilities (fs, execa, logger, prompts) - Plugin functionality (git, config, telemetry) - Configuration and state management
