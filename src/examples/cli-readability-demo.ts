...
import { createLogger, intro, note, outro, printSection, printSeparator } from '../core/index.js';
...
async function runFullDemo(): Promise<void> {
  ...
  note(
    'This demo compares poor vs. excellent CLI readability patterns.\n\nWatch how visual hierarchy and clear sections improve user experience.',
    'Demo Overview'
  );
...
export { demoBadReadability, demoGoodReadability, demoComparisonSummary, runFullDemo };
