...
describe('Enhanced Logger with Icons', () => {
  ...
  describe('withIcon Method', () => {
    ...
    it('should handle invalid icon names gracefully', () => {
      ...
      expect(clackLog.message).not.toHaveBeenCalledWith(
  ...
  describe('Semantic Icon Methods', () => {
    ...
    describe('Infrastructure & Deployment', () => {
      ...
      it('should provide package method', () => {
        ...
        expect(clackLog.message).toHaveBeenCalledWith('📦 \u001b[34mCreating deployment package\u001b[39m');
      });
      ...
      it('should provide database method', () => {
        ...
        expect(clackLog.message).toHaveBeenCalledWith('💾 \u001b[34mConnecting to PostgreSQL\u001b[39m');
      });

      it('should provide api method', () => {
        logger.api('Initializing REST endpoints');
        expect(clackLog.message).toHaveBeenCalledWith('🔗 \u001b[34mInitializing REST endpoints\u001b[39m');
      });

      it('should provide network method', () => {
        logger.network('Configuring load balancer');
        expect(clackLog.message).toHaveBeenCalledWith('🌐 \u001b[34mConfiguring load balancer\u001b[39m');
      });

      it('should provide globe method', () => {
        logger.globe('Updating DNS records');
        expect(clackLog.message).toHaveBeenCalledWith('🌍 \u001b[34mUpdating DNS records\u001b[39m');
      });
    });
    ...
    describe('File & Folder Operations', () => {
      it('should provide folder method', () => {
        ...
        expect(clackLog.message).toHaveBeenCalledWith('📁 \u001b[34mCreating directory structure\u001b[39m');
      });

      it('should provide file method', () => {
        logger.file('Generating config files');
        expect(clackLog.message).toHaveBeenCalledWith('📄 \u001b[34mGenerating config files\u001b[39m');
      });
      ...
      it('should provide download method', () => {
        ...
        // The actual call includes ANSI color codes for INFO level (blue)
        expect(clackLog.message).toHaveBeenCalledWith('⬇️ \u001b[34mDownloading dependencies\u001b[39m');
      });
    ...
    describe('Security & Configuration', () => {
      it('should provide shield method', () => {
        ...
        expect(clackLog.message).toHaveBeenCalledWith('🛡️ \u001b[34mInitializing security protocols\u001b[39m');
      });
      ...
      it('should provide lock method', () => {
        ...
        expect(clackLog.message).toHaveBeenCalledWith('🔒 \u001b[34mEncrypting sensitive data\u001b[39m');
      });

      it('should provide gear method', () => {
        logger.gear('Applying configuration');
        expect(clackLog.message).toHaveBeenCalledWith('⚙️ \u001b[34mApplying configuration\u001b[39m');
      });
    });
    ...
    describe('Process & Status', () => {
      it('should provide build method', () => {
        ...
        expect(clackLog.message).toHaveBeenCalledWith('🔨 \u001b[34mBuilding application\u001b[39m');
      });

      it('should provide deploy method', () => {
        logger.deploy('Deploying to production');
        expect(clackLog.message).toHaveBeenCalledWith('🚀 \u001b[34mDeploying to production\u001b[39m');
      });

      it('should provide lightning method', () => {
        logger.lightning('Running optimization');
        expect(clackLog.message).toHaveBeenCalledWith('⚡ \u001b[34mRunning optimization\u001b[39m');
      });

      it('should provide pending method', () => {
        logger.pending('Waiting for approval');
        expect(clackLog.message).toHaveBeenCalledWith('⏳ \u001b[34mWaiting for approval\u001b[39m');
      });

      it('should provide skip method', () => {
        logger.skip('Skipping optional step');
        expect(clackLog.message).toHaveBeenCalledWith('⏭️ \u001b[34mSkipping optional step\u001b[39m');
      });
    });
    ...
    describe('Decorative Icons', () => {
      it('should provide sparkle method', () => {
        ...
        expect(clackLog.message).toHaveBeenCalledWith('✨ \u001b[34mSomething special happened\u001b[39m');
      });

      it('should provide diamond method', () => {
        logger.diamond('Premium feature activated');
        expect(clackLog.message).toHaveBeenCalledWith('💎 \u001b[34mPremium feature activated\u001b[39m');
      });

      it('should provide crown method', () => {
        logger.crown('Admin access granted');
        expect(clackLog.message).toHaveBeenCalledWith('👑 \u001b[34mAdmin access granted\u001b[39m');
      });

      it('should provide trophy method', () => {
        logger.trophy('Achievement unlocked');
        expect(clackLog.message).toHaveBeenCalledWith('🏆 \u001b[34mAchievement unlocked\u001b[39m');
      });
    });
  });
  ...
  describe('testIcons Method', () => {
    it('should display comprehensive icon test', () => {
      ...
      expect(clackLog.message).toHaveBeenCalledWith(
        expect.stringContaining('Platform Icon Test')
      );
  ...
  describe('Security Integration', () => {
    ...
    it('should handle security validation failures gracefully', () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('Invalid icon')
      );
    });
  ...
  describe('Integration with Existing Logger Features', () => {
    ...
    it('should work with child loggers', () => {
      ...
      expect(clackLog.message).toHaveBeenCalledWith('\u001b[90m[deployment]\u001b[39m ^ \u001b[34mChild logger test\u001b[39m');
    });
